...
const items = [
  ...
  },
  {
    ...
    content: 'Đậu lăng, đậu nành, đậu phộng, đậu Hà Lan chứa nhiều chất xơ, protein cùng nhiều vitamin và khoáng chất giúp giảm lượng đường trong máu, tốt cho tim...',
    image: img3
  }
]
</script>
